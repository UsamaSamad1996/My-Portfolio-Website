    ...
    >
      ...
      <div className="socialMediaLinks h-full w-[5rem] bg-black absolute left-0 top-0 z-10 pt-20 border-r-[1px] border-grey ">
        ...
        <a href="https://github.com/UsamaSamad1996">
          <div className="Github w-full flex justify-center items-center h-16 hover:bg-slate-900">
            <svg
              fill="#05FDD8"
              width="24px"
              height="24px"
        ...
        <a href="https://web.facebook.com/usama.samad.56">
          <div className="facebook w-full flex justify-center items-center h-16 hover:bg-slate-900">
            <svg
              fill="#05FDD8"
              width="24px"
              height="28px"
        ...
        <a href="https://wa.me/923242119160">
          <div className="whatApp w-full flex justify-center items-center h-16 hover:bg-slate-900">
            <svg
              width="28px"
              height="28px"
              viewBox="0 0 20 20"
        ...
        <a href="http://instagram.com/usama_samad1996/">
          <div className="instagram w-full flex justify-center items-center h-16 hover:bg-slate-900">
            <svg
              fill="#05FDD8"
              width="30px"
              height="30px"
      ...
      <div className="Wrapper w-full h-full  text-white font-libra  flex items-start  justify-between  py-16 px-36 absolute bg-slate-900 bg-opacity-0 border-t-[1px] border-grey">
        <div className="first w-[60%] pt-5">
          ...
          <h3 className="text-7xl font-extrabold">Web Developer</h3>
          <p className="font-libra text-2xl pt-5 w-[90%] pl-1 ">
